...
export const STYLE_SHEET = [
  ...
  '.dgw-textarea{width:100%;box-sizing:border-box;min-height:34px;padding:7px 10px;border:1px solid var(--dsw-alias-border-l1);border-radius:8px;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);font-size:13px;line-height:18px;resize:vertical;outline:none;transition:border-color .12s ease}',
  '.dgw-textarea:focus{border-color:var(--dsw-alias-brand-primary)}',
  '.dgw-textarea::placeholder{color:var(--dsw-alias-label-caption)}',
  '.dgw-stagebtn{display:flex;align-items:center;justify-content:center;gap:6px;width:100%;height:30px;padding:0 10px;border:1px solid var(--dsw-alias-border-l1);border-radius:8px;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);font-size:13px;font-weight:500;cursor:pointer;transition:background .12s ease}',
  ...
  '.dgw-mergebtn{display:flex;align-items:center;justify-content:center;gap:6px;width:100%;height:32px;padding:0 10px;border:none;border-radius:8px;background:var(--dsw-alias-state-success-primary);color:#fff;font-family:var(--dsw-font-family);font-size:13px;font-weight:600;cursor:pointer;transition:filter .12s ease}',
  '.dgw-mergebtn:hover:not(:disabled){filter:brightness(1.08)}',
  '.dgw-mergebtn:disabled{opacity:.5;cursor:default}',
  '.dgw-linkicon{display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;border-radius:6px;color:var(--dsw-alias-label-caption);text-decoration:none;flex:none;transition:background .12s ease,color .12s ease}',
  ...
  '.dgw-actionmenu{position:absolute;right:0;top:calc(100% + 8px);width:250px;max-height:calc(100vh - 180px);overflow-y:auto;padding:7px;border:1px solid var(--dsw-alias-border-l1);border-radius:12px;background:var(--dsw-alias-bg-layer-2);box-shadow:-8px 12px 30px rgba(0,0,0,.16);z-index:5}',
  '.dgw-action{display:block;width:100%;padding:8px 12px;border:0;border-radius:7px;background:none;color:var(--dsw-alias-label-primary);font:14px var(--dsw-font-family);text-align:left;cursor:pointer}',
  ...
  '.dgw-actionsep{height:1px;margin:5px 0;background:var(--dsw-alias-border-l1)}',
].join('\n')
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      count != null
        ? React.createElement(
            'span',
            { style: { fontSize: '12px', fontWeight: 600, color: 'var(--dsw-alias-label-caption)' } },
            String(count),
          )
        : null,
